...
# Daily Note and Summary for {{date:dddd YYYY-MM-DD}}
...
<!-- Key observations and quick task for the day; Shutdown: Notes / lingering thoughts-->
...
<!-- Finished tasks add to weekly; Shutdown: Capture Loose Ends - Unfinished tasks  -->
